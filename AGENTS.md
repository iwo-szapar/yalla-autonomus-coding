...
- Non-tiny, ambiguous, autopilot, or high-risk runs challenge the requirement before implementation.
- High-risk mutation groups record pre/post change snapshots, verification, redactions, and rollback posture.
